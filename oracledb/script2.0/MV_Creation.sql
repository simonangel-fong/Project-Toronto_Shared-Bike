...
--ALTER TABLESPACE MV_TBSP
--ADD DATAFILE '/u02/oradata/CDB1/toronto_shared_bike/MV_TBSP02.dbf' SIZE 100M AUTOEXTEND ON NEXT 50M MAXSIZE 2G;

-- Grant privileges on tbsp
ALTER USER DW_SCHEMA QUOTA UNLIMITED ON MV_TBSP;
